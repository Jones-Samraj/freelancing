      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="p-8 border-rose-200 dark:border-rose-900/40 bg-rose-50/30 dark:bg-rose-950/10">
          <h3 className="text-lg font-bold text-rose-700 dark:text-rose-400 mb-4 flex items-center gap-2">
            <span>✕</span> Traditional Bidding Platforms
          </h3>
          <ul className="space-y-3 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            <li className="flex items-start gap-2">
              <span className="text-rose-500 font-bold">•</span>
              <span>Hundreds of automated spam bids on every project posting.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-rose-500 font-bold">•</span>
              <span>No guarantee of code quality, test coverage, or maintainability.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-rose-500 font-bold">•</span>
              <span>Freelancers ghost or disappear halfway through the project.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-rose-500 font-bold">•</span>
              <span>Arbitrary disputes with non-technical platform support staff.</span>
            </li>
          </ul>
        </Card>
        ...
        <Card className="p-8 border-blue-200 dark:border-blue-900/60 bg-blue-50/40 dark:bg-blue-950/20 shadow-md">
          ...
          <ul className="space-y-3 text-xs text-slate-700 dark:text-slate-200 leading-relaxed">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Dedicated Management:</strong> A single Technical Lead coordinates full execution.</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
              <span><strong>Itemized Proposals:</strong> Transparent, line-item quotations for every deliverable.</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
              <span><strong>Milestone Escrow:</strong> Pay only when you review and approve working software.</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
              <span><strong>Full Lifecycle:</strong> We build, support, and maintain your systems long-term.</span>
            </li>
          </ul>
        </Card>
      </div>
